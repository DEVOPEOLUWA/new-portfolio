import { defineComponent, ref, computed, unref, nextTick, reactive, mergeProps, watch, withCtx, createTextVNode, createVNode, resolveDynamicComponent, toDisplayString, useSSRContext } from 'vue';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderClass, ssrRenderStyle, ssrRenderList, ssrRenderAttr, ssrInterpolate, ssrRenderTeleport, ssrRenderVNode, ssrIncludeBooleanAttr } from 'vue/server-renderer';
import { u as useTheme } from './useTheme-6FkntYwY.mjs';
import { _ as _export_sfc } from './_plugin-vue_export-helper-1tPrXgE0.mjs';
import * as THREE from 'three';
import { _ as __nuxt_component_0 } from './nuxt-link-D2KADB1i.mjs';
import './server.mjs';
...
function useLenis() {
  ...
  const scrollTo = (target, options) => {
    var _a, _b;
    lenisInstance == null ? void 0 : lenisInstance.scrollTo(target, {
      offset: (_a = options == null ? void 0 : options.offset) != null ? _a : 0,
      duration: (_b = options == null ? void 0 : options.duration) != null ? _b : 1.5
    });
  };
  const stop = () => lenisInstance == null ? void 0 : lenisInstance.stop();
  const start = () => lenisInstance == null ? void 0 : lenisInstance.start();
  const destroy = () => {
...
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const scrambleTo = (target) => {
      ...
      scrambleInterval = setInterval$1();
    };
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const timeline = [
      { role: "Frontend Engineer", company: "Encentral Solutions \xB7 Abuja", date: "Nov 2022 \u2014 Present" },
      { role: "Frontend Engineer Intern", company: "Encentral Solutions \xB7 Abuja", date: "Apr 2022 \u2014 Nov 2022" }
    ];
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(skills, (skill, si) => {
        ...
        if (si < skills.length - 1) {
          _push(`<span class="skill-dot" data-v-81b9649a> \xB7 </span>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</span>`);
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--]--><div class="row-divider" style="${ssrRenderStyle({ "opacity": "0" })}" data-v-76c5d01a></div></div></div><div class="footer-bar" data-v-76c5d01a><div class="footer-rule" data-v-76c5d01a></div><div class="footer-inner" data-v-76c5d01a><span class="footer-text" data-v-76c5d01a>\xA9 2025 Opeoluwa Ayodeji</span><span class="footer-text hidden md:block" data-v-76c5d01a>Design &amp; Engineering by O.A</span><button class="footer-text footer-top-btn" data-v-76c5d01a>BACK TO TOP \u2191</button></div></div></section>`);
    };
  }
});
...
//# sourceMappingURL=index-DwwxCWdc.mjs.map
