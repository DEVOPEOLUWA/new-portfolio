...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const allProjects = [
      {
        ...
        category: "Enterprise \xB7 Fintech",
      ...
      },
      {
        ...
        category: "Government \xB7 Procurement",
      ...
      },
      {
        ...
        category: "Regulatory \xB7 Government",
    ...
    const project = computed(() => {
      var _a;
      return (_a = allProjects.find((p) => p.slug === slug.value)) != null ? _a : allProjects[0];
    });
...
//# sourceMappingURL=_slug_-D55LgPkk.mjs.map
